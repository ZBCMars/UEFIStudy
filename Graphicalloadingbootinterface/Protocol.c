...
UefiMain(EFI_HANDLE ImageHandle, EFI_SYSTEM_TABLE *SystemTable)
{
    ...
    EFI_PHYSICAL_ADDRESS BlueStart = Gop->Mode->FrameBufferBase + Gop->Mode->Info->PixelsPerScanLine * 400;

    EFI_GRAPHICS_OUTPUT_BLT_PIXEL *PixelHandle = (EFI_GRAPHICS_OUTPUT_BLT_PIXEL*) BlueStart;
